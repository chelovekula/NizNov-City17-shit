...
final class RealCall implements Call {
    ...
    public C1069Response execute() throws IOException {
        synchronized (this) {
            if (!this.executed) {
                this.executed = true;
            } else {
        ...
        try {
            ...
            C1069Response responseWithInterceptorChain = getResponseWithInterceptorChain();
    ...
    /* access modifiers changed from: 0000 */
    public C1069Response getResponseWithInterceptorChain() throws IOException {
