...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f119dn;
    private int end;
    private final int length = this.f119dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f119dn = x500Principal.getName("RFC2253");
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f119dn.toCharArray();
