...
public final class CacheStrategy {
    @Nullable
    public final C1069Response cacheResponse;
    @Nullable
    ...
    public static class Factory {
        ...
        public Factory(long j, Request request2, C1069Response response) {
            this.nowMillis = j;
    ...
    CacheStrategy(Request request, C1069Response response) {
    ...
    public static boolean isCacheable(okhttp3.C1069Response r3, okhttp3.Request r4) {
        /*
            int r0 = r3.code()
