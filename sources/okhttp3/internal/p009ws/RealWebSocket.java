...
import okhttp3.internal.p009ws.WebSocketReader.FrameCallback;
...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m177of(bArr).base64();
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        this.call.enqueue(new Callback() {
            public void onResponse(Call call, C1069Response response) {
                try {
    ...
    public void checkResponse(C1069Response response) throws ProtocolException {
        String str = "'";
    ...
    public synchronized void onReadPing(okio.ByteString r2) {
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p009ws.RealWebSocket.onReadPing(okio.ByteString):void");
    }
    ...
    private synchronized boolean send(okio.ByteString r7, int r8) {
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p009ws.RealWebSocket.send(okio.ByteString, int):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0058, code lost:
        if ((r5 instanceof okhttp3.internal.p009ws.RealWebSocket.Message) == false) goto L_0x0086;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x005a, code lost:
        r1 = ((okhttp3.internal.p009ws.RealWebSocket.Message) r5).data;
        r0 = okio.Okio.buffer(r0.newMessageSink(((okhttp3.internal.p009ws.RealWebSocket.Message) r5).formatOpcode, (long) r1.size()));
        r0.write(r1);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0088, code lost:
        if ((r5 instanceof okhttp3.internal.p009ws.RealWebSocket.Close) == false) goto L_0x009f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008a, code lost:
        r5 = (okhttp3.internal.p009ws.RealWebSocket.Close) r5;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p009ws.RealWebSocket.Close     // Catch:{ all -> 0x00aa }
        ...
        L_0x0031:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p009ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00aa }
        ...
        L_0x004f:
            ...
            goto L_0x009a
        L_0x0056:
            boolean r2 = r5 instanceof okhttp3.internal.p009ws.RealWebSocket.Message     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x0086
            r1 = r5
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p009ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x00a5 }
            okio.ByteString r1 = r1.data     // Catch:{ all -> 0x00a5 }
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p009ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00a5 }
        ...
        L_0x0086:
            boolean r2 = r5 instanceof okhttp3.internal.p009ws.RealWebSocket.Close     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x009f
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p009ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00a5 }
        ...
        L_0x00aa:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p009ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    public void writePingFrame() {
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p009ws.RealWebSocket.writePingFrame():void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void failWebSocket(java.lang.Exception r4, @javax.annotation.Nullable okhttp3.C1069Response r5) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p009ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }
}
