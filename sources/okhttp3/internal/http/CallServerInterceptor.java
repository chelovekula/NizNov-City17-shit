...
public final class CallServerInterceptor implements Interceptor {
    ...
    public C1069Response intercept(Chain chain) throws IOException {
        ...
        C1069Response build = builder.request(request).handshake(streamAllocation.connection().handshake()).sentRequestAtMillis(currentTimeMillis).receivedResponseAtMillis(System.currentTimeMillis()).build();
        int code = build.code();
        if (code == 100) {
