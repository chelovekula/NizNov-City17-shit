...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public C1069Response intercept(Chain chain) throws IOException {
        ...
        C1069Response response = null;
        int i = 0;
        while (!this.canceled) {
            try {
                C1069Response proceed = realInterceptorChain.proceed(request, streamAllocation2, null, null);
                if (response != null) {
    ...
    private Request followUpRequest(C1069Response response, Route route) throws IOException {
        Proxy proxy;
        if (response != null) {
    ...
    private int retryAfter(C1069Response response, int i) {
    ...
    private boolean sameConnection(C1069Response response, HttpUrl httpUrl) {
