...
public final class RealInterceptorChain implements Chain {
    ...
    public C1069Response proceed(Request request2) throws IOException {
        return proceed(request2, this.streamAllocation, this.httpCodec, this.connection);
    }

    public C1069Response proceed(Request request2, StreamAllocation streamAllocation2, HttpCodec httpCodec2, RealConnection realConnection) throws IOException {
        if (this.index < this.interceptors.size()) {
            ...
            if (this.httpCodec == null || this.connection.supportsUrl(request2.url())) {
                ...
                if (this.httpCodec == null || this.calls <= 1) {
                    ...
                    C1069Response intercept = interceptor.intercept(realInterceptorChain);
