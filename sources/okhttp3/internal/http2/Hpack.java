...
final class Hpack {
    ...
    static final class Reader {
        ...
        public ByteString readByteString() throws IOException {
            ...
            if (z) {
                return ByteString.m177of(Huffman.get().decode(this.source.readByteArray((long) readInt)));
            }
