...
import okhttp3.internal.p009ws.RealWebSocket.Streams;
...
public final class RealConnection extends Listener implements Connection {
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            C1069Response build = http1Codec.readResponseHeaders(false).request(request).build();
    ...
    private Request createTunnelRequest() throws IOException {
        ...
        Request authenticate = this.route.address().proxyAuthenticator().authenticate(this.route, new C1069Response.Builder().request(build).protocol(Protocol.HTTP_1_1).code(407).message("Preemptive Authenticate").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1).receivedResponseAtMillis(-1).header("Proxy-Authenticate", "OkHttp-Preemptive").build());
    ...
    public Streams newWebSocketStreams(StreamAllocation streamAllocation) {
        ...
        C10791 r0 = new Streams(true, this.source, this.sink) {
