...
public final class DurationKt {
    ...
    private static final double m1153timesmvk6XK0(int i, double d) {
        return Duration.m1135timesimpl(d, i);
    }
    ...
    private static final double m1152timeskIfJnKk(double d, double d2) {
        return Duration.m1134timesimpl(d2, d);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m1108constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
