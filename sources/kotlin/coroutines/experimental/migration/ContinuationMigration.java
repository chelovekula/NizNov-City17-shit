...
final class ContinuationMigration<T> implements Continuation<T> {
    ...
    public void resumeWith(@NotNull Object obj) {
        ...
        Throwable r2 = Result.m186exceptionOrNullimpl(obj);
        if (r2 != null) {
