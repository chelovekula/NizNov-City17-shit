...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        return (z || i != C0134R.C0136id.accessibility_action_clickable_span) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

    private boolean performClickableSpanAction(int i, View view) {
        SparseArray sparseArray = (SparseArray) view.getTag(C0134R.C0136id.tag_accessibility_clickable_spans);
        if (sparseArray != null) {
    ...
    static List<AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityActionCompat> list = (List) view.getTag(C0134R.C0136id.tag_accessibility_actions);
