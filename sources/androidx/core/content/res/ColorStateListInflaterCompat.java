...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next != 2 || depth2 > depth || !xmlPullParser.getName().equals("item")) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet2, C0134R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0134R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0134R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0134R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0134R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0134R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0134R.attr.alpha)) {
                        int i5 = i3 + 1;
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = 0.0d, mo601to = 1.0d) float f) {
