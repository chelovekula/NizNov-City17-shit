...
public class LifecycleRegistry extends Lifecycle {
    ...
    static /* synthetic */ class C02481 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C02481.<clinit>():void");
        }
    }
    ...
    private static Event downEvent(State state) {
        int i = C02481.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
