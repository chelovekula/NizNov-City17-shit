...
class TranslationAnimationCreator {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter implements TransitionListener {
        ...
        private int[] mTransitionPosition = ((int[]) this.mViewInHierarchy.getTag(C0343R.C0345id.transition_position));
        ...
        TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2) {
            ...
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0343R.C0345id.transition_position, null);
            }
        }
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            this.mViewInHierarchy.setTag(C0343R.C0345id.transition_position, this.mTransitionPosition);
        }
    ...
    static Animator createAnimation(@NonNull View view, @NonNull TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, @Nullable TimeInterpolator timeInterpolator, @NonNull Transition transition) {
        ...
        int[] iArr = (int[]) transitionValues2.view.getTag(C0343R.C0345id.transition_position);
        if (iArr != null) {
