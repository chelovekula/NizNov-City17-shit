...
public class ChangeImageTransform extends Transition {
    ...
    static /* synthetic */ class C03323 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C03323.<clinit>():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        if (drawable.getIntrinsicWidth() > 0 && drawable.getIntrinsicHeight() > 0) {
            int i = C03323.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
            if (i == 1) {
