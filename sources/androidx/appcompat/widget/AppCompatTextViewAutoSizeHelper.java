...
class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, C0033R.styleable.AppCompatTextView, i, 0);
        if (obtainStyledAttributes.hasValue(C0033R.styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = obtainStyledAttributes.getInt(C0033R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        ...
        if (obtainStyledAttributes.hasValue(C0033R.styleable.AppCompatTextView_autoSizePresetSizes)) {
            int resourceId = obtainStyledAttributes.getResourceId(C0033R.styleable.AppCompatTextView_autoSizePresetSizes, 0);
            if (resourceId > 0) {
