...
public class AppCompatTextView extends TextView implements TintableBackgroundView, AutoSizeableTextView {
    ...
    public void setFirstBaselineToTopHeight(@C0032Px @IntRange(from = 0) int i) {
    ...
    public void setLastBaselineToBottomHeight(@C0032Px @IntRange(from = 0) int i) {
        if (VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0032Px @IntRange(from = 0) int i) {
