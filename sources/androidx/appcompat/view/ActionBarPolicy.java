...
public class ActionBarPolicy {
    ...
    public boolean hasEmbeddedTabs() {
        return this.mContext.getResources().getBoolean(C0033R.bool.abc_action_bar_embed_tabs);
    }
    ...
    public int getStackedTabMaxWidth() {
        return this.mContext.getResources().getDimensionPixelSize(C0033R.dimen.abc_action_bar_stacked_tab_max_width);
    }
}
