...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        appendModifier(sb, i, 65536, resources.getString(C0033R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i, 4096, resources.getString(C0033R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i, 2, resources.getString(C0033R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i, 1, resources.getString(C0033R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i, 4, resources.getString(C0033R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i, 8, resources.getString(C0033R.string.abc_menu_function_shortcut_label));
        if (shortcut == 8) {
