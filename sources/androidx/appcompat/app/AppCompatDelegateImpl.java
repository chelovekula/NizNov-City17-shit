...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0033R.attr.homeAsUpIndicator});
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0033R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0033R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0033R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            obtainStyledAttributes.recycle();
        }
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0033R.layout.abc_list_menu_item_layout);
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0033R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0033R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0033R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            this.mWindow.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0033R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0033R.layout.abc_screen_simple, null);
                }
                ...
                viewGroup = (ViewGroup) from.inflate(C0033R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0033R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    context = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0033R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0033R.C0035id.decor_content_parent);
            ...
            if (viewGroup != null) {
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0033R.C0035id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0033R.C0035id.action_bar_activity_content);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(@androidx.annotation.NonNull androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0029:
            ...
            int r5 = androidx.appcompat.C0033R.attr.actionBarTheme
        ...
        L_0x006a:
            ...
            int r6 = androidx.appcompat.C0033R.attr.actionModePopupWindowStyle
            r5.<init>(r4, r1, r6)
            ...
            int r6 = androidx.appcompat.C0033R.attr.actionBarSize
        ...
        L_0x00b7:
            ...
            int r4 = androidx.appcompat.C0033R.C0035id.action_mode_bar_stub
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C0033R.styleable.AppCompatTheme).getString(C0033R.styleable.AppCompatTheme_viewInflaterClass);
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0033R.color.abc_input_method_navigation_guard));
