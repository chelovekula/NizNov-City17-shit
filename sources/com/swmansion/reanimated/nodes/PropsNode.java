...
public class PropsNode extends Node implements FinalNode {
    ...
    static /* synthetic */ class C10341 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.swmansion.reanimated.nodes.PropsNode.C10341.<clinit>():void");
        }
    }
    ...
    public PropsNode(int i, ReadableMap readableMap, NodesManager nodesManager, UIImplementation uIImplementation) {
        ...
        this.mMapping = C1007Utils.processMapping(readableMap.getMap("props"));
        ...
        for (Entry entry : this.mMapping.entrySet()) {
            ...
            if (findNodeById instanceof StyleNode) {
                ...
                while (keySetIterator.hasNextKey()) {
                    ...
                    int i = C10341.$SwitchMap$com$facebook$react$bridge$ReadableType[type.ordinal()];
                    if (i == 1) {
