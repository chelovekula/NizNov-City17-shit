...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        ...
        this.mContainer = (ViewGroup) LayoutInflater.from(this.mContext).inflate(C0902R.layout.amu_text_bubble, null);
        this.mRotationLayout = (RotationLayout) this.mContainer.getChildAt(0);
        TextView textView = (TextView) this.mRotationLayout.findViewById(C0902R.C0904id.amu_text);
    ...
    public void setContentView(View view) {
        ...
        View findViewById = this.mRotationLayout.findViewById(C0902R.C0904id.amu_text);
    ...
    private static int getTextStyle(int i) {
        if (i == 3 || i == 4 || i == 5 || i == 6 || i == 7) {
            return C0902R.style.amu_Bubble_TextAppearance_Light;
        }
        return C0902R.style.amu_Bubble_TextAppearance_Dark;
    }
}
