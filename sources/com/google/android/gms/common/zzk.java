...
public final class zzk extends AbstractSafeParcelable {
    ...
    @Field(getter = "getAllowTestKeys", mo12619id = 3)
    private final boolean zzaa;
    @Field(defaultValue = "false", getter = "getForbidTestKeys", mo12619id = 4)
    private final boolean zzab;
    @Field(getter = "getCallingPackage", mo12619id = 1)
    private final String zzy;
    @Field(getter = "getCallingCertificateBinder", mo12619id = 2, type = "android.os.IBinder")
    @Nullable
    private final zze zzz;

    @Constructor
    zzk(@Param(mo12622id = 1) String str, @Param(mo12622id = 2) @Nullable IBinder iBinder, @Param(mo12622id = 3) boolean z, @Param(mo12622id = 4) boolean z2) {
        this.zzy = str;
