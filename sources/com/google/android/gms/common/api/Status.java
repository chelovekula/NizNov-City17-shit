...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo12619id = 1)
    private final int zzh;
    @Field(getter = "getPendingIntent", mo12619id = 3)
    @Nullable
    private final PendingIntent zzi;
    @Field(getter = "getStatusMessage", mo12619id = 2)
    @Nullable
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo12622id = 1000) int i, @Param(mo12622id = 1) int i2, @Param(mo12622id = 2) @Nullable String str, @Param(mo12622id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
