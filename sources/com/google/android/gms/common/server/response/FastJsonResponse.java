...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @VersionField(getter = "getVersionCode", mo12625id = 1)
        private final int zalf;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeIn", mo12619id = 2)
        protected final int zapr;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeInArray", mo12619id = 3)
        protected final boolean zaps;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeOut", mo12619id = 4)
        protected final int zapt;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeOutArray", mo12619id = 5)
        protected final boolean zapu;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getOutputFieldName", mo12619id = 6)
        protected final String zapv;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo12619id = 7)
        protected final int zapw;
        protected final Class<? extends FastJsonResponse> zapx;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getConcreteTypeName", mo12619id = 8)
        private final String zapy;
        private zak zapz;
        /* access modifiers changed from: private */
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getWrappedConverter", mo12619id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zaqa;

        @Constructor
        Field(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) int i2, @Param(mo12622id = 3) boolean z, @Param(mo12622id = 4) int i3, @Param(mo12622id = 5) boolean z2, @Param(mo12622id = 6) String str, @Param(mo12622id = 7) int i4, @Param(mo12622id = 8) String str2, @Param(mo12622id = 9) zaa zaa) {
            this.zalf = i;
            this.zapr = i2;
            this.zaps = z;
            this.zapt = i3;
