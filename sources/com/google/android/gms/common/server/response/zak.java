...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo12619id = 2)
    private final ArrayList<zal> zaqw;
    @SafeParcelable.Field(getter = "getRootClassName", mo12619id = 3)
    private final String zaqx;

    @Constructor
    zak(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) ArrayList<zal> arrayList, @Param(mo12622id = 3) String str) {
        this.zalf = i;
        this.zaqw = null;
