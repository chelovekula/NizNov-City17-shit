...
public final class StringToIntConverter extends AbstractSafeParcelable implements FieldConverter<String, Integer> {
    ...
    @Field(getter = "getSerializedMap", mo12619id = 2)
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @Constructor
        zaa(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) String str, @Param(mo12622id = 3) int i2) {
            this.versionCode = i;
            this.zapp = str;
            this.zapq = i2;
        }
    ...
    @Constructor
    StringToIntConverter(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) ArrayList<zaa> arrayList) {
        this.zalf = i;
