...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @VersionField(mo12625id = 1000)
    private final int zalf;
    @Field(getter = "getColumns", mo12619id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @Field(getter = "getWindows", mo12619id = 2)
    private final CursorWindow[] zals;
    @Field(getter = "getStatusCode", mo12619id = 3)
    private final int zalt;
    @Field(getter = "getMetadata", mo12619id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo12622id = 1000) int i, @Param(mo12622id = 1) String[] strArr, @Param(mo12622id = 2) CursorWindow[] cursorWindowArr, @Param(mo12622id = 3) int i2, @Param(mo12622id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
