...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo12619id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo12619id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo12619id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) int i2, @Param(mo12622id = 3) PendingIntent pendingIntent, @Param(mo12622id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
