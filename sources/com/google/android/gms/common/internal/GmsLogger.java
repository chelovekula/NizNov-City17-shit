...
public final class GmsLogger {
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo12554d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo12555d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo12563v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo12564v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo12559i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo12560i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo12565w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo12566w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo12556e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo12557e(String str, String str2, Throwable th) {
        if (canLog(6)) {
