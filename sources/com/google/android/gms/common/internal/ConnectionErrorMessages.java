...
import com.google.android.gms.common.C0897R;
...
public final class ConnectionErrorMessages {
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C0894R.string.common_google_play_services_install_text, new Object[]{appName});
        } else if (i != 2) {
            if (i == 3) {
                return resources.getString(C0894R.string.common_google_play_services_enable_text, new Object[]{appName});
            } else if (i == 5) {
                ...
                if (i == 9) {
                    return resources.getString(C0894R.string.common_google_play_services_unsupported_text, new Object[]{appName});
                } else if (i == 20) {
                    ...
                    switch (i) {
                        ...
                        case 18:
                            return resources.getString(C0894R.string.common_google_play_services_updating_text, new Object[]{appName});
                        default:
                            return resources.getString(C0897R.string.common_google_play_services_unknown_issue, new Object[]{appName});
                    }
                }
            }
            ...
            return resources.getString(C0894R.string.common_google_play_services_update_text, new Object[]{appName});
        }
    }
    ...
    private static String zaa(Context context, String str, String str2) {
        ...
        if (zaa == null) {
            zaa = resources.getString(C0897R.string.common_google_play_services_unknown_issue);
        }
