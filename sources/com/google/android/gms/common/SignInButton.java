...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            this.mSize = obtainStyledAttributes.getInt(C0894R.styleable.SignInButton_buttonSize, 0);
            this.mColor = obtainStyledAttributes.getInt(C0894R.styleable.SignInButton_colorScheme, 2);
