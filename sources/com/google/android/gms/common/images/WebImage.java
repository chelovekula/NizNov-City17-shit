...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getHeight", mo12619id = 4)
    private final int zanf;
    @Field(getter = "getUrl", mo12619id = 2)
    private final Uri zang;

    @Constructor
    WebImage(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) Uri uri, @Param(mo12622id = 3) int i2, @Param(mo12622id = 4) int i3) {
        this.zalf = i;
        this.zang = uri;
        this.zane = i2;
        this.zanf = i3;
