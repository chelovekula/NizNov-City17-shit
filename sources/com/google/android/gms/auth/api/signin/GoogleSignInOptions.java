...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo12619id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo12619id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo12619id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo12619id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo12619id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo12619id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo12619id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo12619id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) ArrayList<Scope> arrayList, @Param(mo12622id = 3) Account account, @Param(mo12622id = 4) boolean z, @Param(mo12622id = 5) boolean z2, @Param(mo12622id = 6) boolean z3, @Param(mo12622id = 7) String str, @Param(mo12622id = 8) String str2, @Param(mo12622id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
