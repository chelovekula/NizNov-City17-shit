...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo12619id = 3)
    ...
    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo12622id = 1) int i, @Param(mo12622id = 2) int i2, @Param(mo12622id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
