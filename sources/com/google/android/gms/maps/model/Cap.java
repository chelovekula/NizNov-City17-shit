...
public class Cap extends AbstractSafeParcelable {
    ...
    @Field(getter = "getWrappedBitmapDescriptorImplBinder", mo12619id = 3, type = "android.os.IBinder")
    @Nullable
    private final BitmapDescriptor bitmapDescriptor;
    @Field(getter = "getType", mo12619id = 2)
    private final int type;
    @Field(getter = "getBitmapRefWidth", mo12619id = 4)
    @Nullable
    ...
    @Constructor
    Cap(@Param(mo12622id = 2) int i, @Param(mo12622id = 3) @Nullable IBinder iBinder, @Param(mo12622id = 4) @Nullable Float f) {
