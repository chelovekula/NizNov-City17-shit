...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBearing", mo12619id = 7)
    private float bearing;
    @Field(getter = "getHeight", mo12619id = 5)
    private float height;
    @Field(getter = "getWidth", mo12619id = 4)
    private float width;
    @Field(getter = "getZIndex", mo12619id = 8)
    private float zzcs;
    @Field(getter = "isVisible", mo12619id = 9)
    private boolean zzct = true;
    @Field(getter = "isClickable", mo12619id = 13)
    private boolean zzcu = false;
    @Field(getter = "getWrappedImageDescriptorImplBinder", mo12619id = 2, type = "android.os.IBinder")
    @NonNull
    private BitmapDescriptor zzcx;
    @Field(getter = "getLocation", mo12619id = 3)
    private LatLng zzcy;
    @Field(getter = "getBounds", mo12619id = 6)
    private LatLngBounds zzcz;
    @Field(getter = "getTransparency", mo12619id = 10)
    private float zzda = 0.0f;
    @Field(getter = "getAnchorU", mo12619id = 11)
    private float zzdb = 0.5f;
    @Field(getter = "getAnchorV", mo12619id = 12)
    private float zzdc = 0.5f;

    @Constructor
    GroundOverlayOptions(@Param(mo12622id = 2) IBinder iBinder, @Param(mo12622id = 3) LatLng latLng, @Param(mo12622id = 4) float f, @Param(mo12622id = 5) float f2, @Param(mo12622id = 6) LatLngBounds latLngBounds, @Param(mo12622id = 7) float f3, @Param(mo12622id = 8) float f4, @Param(mo12622id = 9) boolean z, @Param(mo12622id = 10) float f5, @Param(mo12622id = 11) float f6, @Param(mo12622id = 12) float f7, @Param(mo12622id = 13) boolean z2) {
