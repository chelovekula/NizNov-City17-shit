...
public final class StreetViewPanoramaOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getPanoramaId", mo12619id = 3)
    private String panoId;
    @Field(getter = "getPosition", mo12619id = 4)
    private LatLng position;
    @Field(getter = "getUseViewLifecycleInFragmentForParcel", mo12619id = 10, type = "byte")
    private Boolean zzak;
    @Field(getter = "getZoomGesturesEnabledForParcel", mo12619id = 7, type = "byte")
    private Boolean zzap;
    @Field(getter = "getStreetViewPanoramaCamera", mo12619id = 2)
    private StreetViewPanoramaCamera zzbx;
    @Field(getter = "getRadius", mo12619id = 5)
    private Integer zzby;
    @Field(getter = "getUserNavigationEnabledForParcel", mo12619id = 6, type = "byte")
    private Boolean zzbz;
    @Field(getter = "getPanningGesturesEnabledForParcel", mo12619id = 8, type = "byte")
    private Boolean zzca;
    @Field(getter = "getStreetNamesEnabledForParcel", mo12619id = 9, type = "byte")
    private Boolean zzcb;
    @Field(getter = "getSource", mo12619id = 11)
    private StreetViewSource zzcc = StreetViewSource.DEFAULT;

    @Constructor
    StreetViewPanoramaOptions(@Param(mo12622id = 2) StreetViewPanoramaCamera streetViewPanoramaCamera, @Param(mo12622id = 3) String str, @Param(mo12622id = 4) LatLng latLng, @Param(mo12622id = 5) Integer num, @Param(mo12622id = 6) byte b, @Param(mo12622id = 7) byte b2, @Param(mo12622id = 8) byte b3, @Param(mo12622id = 9) byte b4, @Param(mo12622id = 10) byte b5, @Param(mo12622id = 11) StreetViewSource streetViewSource) {
