...
import com.facebook.drawee.C0494R;
    ...
    private void init(Context context, @Nullable AttributeSet attributeSet) {
        ...
        try {
            ...
            if (attributeSet != null) {
                obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0494R.styleable.SimpleDraweeView);
                if (obtainStyledAttributes.hasValue(C0494R.styleable.SimpleDraweeView_actualImageUri)) {
                    setImageURI(Uri.parse(obtainStyledAttributes.getString(C0494R.styleable.SimpleDraweeView_actualImageUri)), (Object) null);
                } else if (obtainStyledAttributes.hasValue(C0494R.styleable.SimpleDraweeView_actualImageResource)) {
                    int resourceId = obtainStyledAttributes.getResourceId(C0494R.styleable.SimpleDraweeView_actualImageResource, -1);
                    if (resourceId != -1) {
                        if (isInEditMode()) {
