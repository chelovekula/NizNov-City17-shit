...
public class GenericDraweeHierarchyInflater {
    ...
    public static com.facebook.drawee.generic.GenericDraweeHierarchyBuilder updateBuilder(com.facebook.drawee.generic.GenericDraweeHierarchyBuilder r18, android.content.Context r19, @javax.annotation.Nullable android.util.AttributeSet r20) {
        /*
            ...
            int[] r6 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy
        ...
        L_0x001e:
            ...
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_actualImageScaleType     // Catch:{ all -> 0x01a2 }
            ...
            goto L_0x00c3
        L_0x0031:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_placeholderImage     // Catch:{ all -> 0x01a2 }
            ...
            goto L_0x00c3
        L_0x003e:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_pressedStateOverlayImage     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x004b
            android.graphics.drawable.Drawable r3 = getDrawable(r1, r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setPressedStateOverlay(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x004b:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_progressBarImage     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x0058
            android.graphics.drawable.Drawable r3 = getDrawable(r1, r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setProgressBarImage(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x0058:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_fadeDuration     // Catch:{ all -> 0x01a2 }
            ...
            goto L_0x00c3
        L_0x0065:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_viewAspectRatio     // Catch:{ all -> 0x01a2 }
            ...
            goto L_0x00c3
        L_0x0072:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_placeholderImageScaleType     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x007e
            com.facebook.drawee.drawable.ScalingUtils$ScaleType r3 = getScaleTypeFromXml(r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setPlaceholderImageScaleType(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x007e:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_retryImage     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x008a
            android.graphics.drawable.Drawable r3 = getDrawable(r1, r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setRetryImage(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x008a:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_retryImageScaleType     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x0096
            com.facebook.drawee.drawable.ScalingUtils$ScaleType r3 = getScaleTypeFromXml(r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setRetryImageScaleType(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x0096:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_failureImage     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x00a2
            android.graphics.drawable.Drawable r3 = getDrawable(r1, r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setFailureImage(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x00a2:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_failureImageScaleType     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x00ae
            com.facebook.drawee.drawable.ScalingUtils$ScaleType r3 = getScaleTypeFromXml(r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setFailureImageScaleType(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x00ae:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_progressBarImageScaleType     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x00ba
            com.facebook.drawee.drawable.ScalingUtils$ScaleType r3 = getScaleTypeFromXml(r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setProgressBarImageScaleType(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x00ba:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_progressBarAutoRotateInterval     // Catch:{ all -> 0x01a2 }
        ...
        L_0x00c3:
            ...
            goto L_0x019c
        L_0x00c6:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_backgroundImage     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x00d2
            android.graphics.drawable.Drawable r3 = getDrawable(r1, r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setBackground(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x00d2:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_overlayImage     // Catch:{ all -> 0x01a2 }
            if (r3 != r4) goto L_0x00de
            android.graphics.drawable.Drawable r3 = getDrawable(r1, r2, r3)     // Catch:{ all -> 0x01a2 }
            r0.setOverlay(r3)     // Catch:{ all -> 0x01a2 }
            goto L_0x00c3
        L_0x00de:
            int r4 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundAsCircle     // Catch:{ all -> 0x01a2 }
            ...
            goto L_0x00c3
        L_0x00ef:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundedCornerRadius     // Catch:{ all -> 0x01a2 }
        ...
        L_0x00fc:
            r4 = r17
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundTopLeft     // Catch:{ all -> 0x01a2 }
        ...
        L_0x0107:
            ...
            goto L_0x00c3
        L_0x010a:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundTopRight     // Catch:{ all -> 0x01a2 }
            if (r3 != r1) goto L_0x0114
            boolean r1 = r2.getBoolean(r3, r11)     // Catch:{ all -> 0x01a2 }
            r11 = r1
            goto L_0x0107
        L_0x0114:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundBottomLeft     // Catch:{ all -> 0x01a2 }
            if (r3 != r1) goto L_0x011e
            boolean r1 = r2.getBoolean(r3, r15)     // Catch:{ all -> 0x01a2 }
            r15 = r1
            goto L_0x0107
        L_0x011e:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundBottomRight     // Catch:{ all -> 0x01a2 }
            if (r3 != r1) goto L_0x0128
            boolean r1 = r2.getBoolean(r3, r13)     // Catch:{ all -> 0x01a2 }
            r13 = r1
            goto L_0x0107
        L_0x0128:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundTopStart     // Catch:{ all -> 0x01a2 }
            if (r3 != r1) goto L_0x0132
            boolean r1 = r2.getBoolean(r3, r10)     // Catch:{ all -> 0x01a2 }
            r10 = r1
            goto L_0x0107
        L_0x0132:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundTopEnd     // Catch:{ all -> 0x01a2 }
            if (r3 != r1) goto L_0x013c
            boolean r1 = r2.getBoolean(r3, r12)     // Catch:{ all -> 0x01a2 }
            r12 = r1
            goto L_0x0107
        L_0x013c:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundBottomStart     // Catch:{ all -> 0x01a2 }
            if (r3 != r1) goto L_0x0146
            boolean r1 = r2.getBoolean(r3, r5)     // Catch:{ all -> 0x01a2 }
            r5 = r1
            goto L_0x0107
        L_0x0146:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundBottomEnd     // Catch:{ all -> 0x01a2 }
            if (r3 != r1) goto L_0x0150
            boolean r1 = r2.getBoolean(r3, r14)     // Catch:{ all -> 0x01a2 }
            r14 = r1
            goto L_0x0107
        L_0x0150:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundWithOverlayColor     // Catch:{ all -> 0x01a2 }
        ...
        L_0x0164:
            r17 = r4
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundingBorderWidth     // Catch:{ all -> 0x01a2 }
            ...
            goto L_0x00c3
        L_0x0179:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundingBorderColor     // Catch:{ all -> 0x01a2 }
            ...
            goto L_0x00c3
        L_0x018b:
            int r1 = com.facebook.drawee.C0494R.styleable.GenericDraweeHierarchy_roundingBorderPadding     // Catch:{ all -> 0x01a2 }
