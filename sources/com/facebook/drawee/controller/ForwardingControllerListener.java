...
public class ForwardingControllerListener<INFO> implements ControllerListener<INFO> {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m118of(ControllerListener<? super INFO> controllerListener) {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m119of(ControllerListener<? super INFO> controllerListener, ControllerListener<? super INFO> controllerListener2) {
        ForwardingControllerListener<INFO> create = create();
        create.addListener(controllerListener);
