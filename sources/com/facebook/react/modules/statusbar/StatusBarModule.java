...
public class StatusBarModule extends ReactContextBaseJavaModule {
    ...
    public void setColor(int i, boolean z) {
        ...
        if (currentActivity == null) {
            FLog.m90w(ReactConstants.TAG, "StatusBarModule: Ignored status bar change, current activity is null.");
            return;
        }
        if (VERSION.SDK_INT >= 21) {
            final boolean z2 = z;
            final int i2 = i;
            C08101 r0 = new GuardedRunnable(getReactApplicationContext()) {
                @TargetApi(21)
