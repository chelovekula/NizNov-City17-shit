...
public abstract class BundleDeltaClient {
    ...
    static /* synthetic */ class C06901 {
        ...
        static final /* synthetic */ int[] f41xca7c22d2 = new int[ClientType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f41xca7c22d2 = r0
                int[] r0 = f41xca7c22d2     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f41xca7c22d2     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.devsupport.BundleDeltaClient.C06901.<clinit>():void");
        }
    }
    ...
    private static class BundleDeltaJavaClient extends BundleDeltaClient {
        ...
        /* synthetic */ BundleDeltaJavaClient(C06901 r1) {
            this();
        }
    ...
    private static class BundleDeltaNativeClient extends BundleDeltaClient {
        ...
        /* synthetic */ BundleDeltaNativeClient(C06901 r1) {
            this();
        }
    ...
    static BundleDeltaClient create(ClientType clientType) {
        int i = C06901.f41xca7c22d2[clientType.ordinal()];
        if (i == 1) {
