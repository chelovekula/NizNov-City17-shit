...
public class FpsView extends FrameLayout {
    ...
    private final TextView mTextView = ((TextView) findViewById(C0604R.C0606id.fps_text));
    ...
    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C0604R.layout.fps_view, this);
    ...
    public void setCurrentFPS(double d, double d2, int i, int i2) {
        ...
        FLog.m38d(ReactConstants.TAG, format);
    }
}
