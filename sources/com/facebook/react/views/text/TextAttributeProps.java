...
public class TextAttributeProps {
    ...
    public TextAttributeProps(ReactStylesDiffMap reactStylesDiffMap) {
        ...
        setColor(reactStylesDiffMap.hasKey(str2) ? Integer.valueOf(reactStylesDiffMap.getInt(str2, 0)) : null);
        String str3 = ViewProps.BACKGROUND_COLOR;
        setBackgroundColor(reactStylesDiffMap.hasKey(str3) ? Integer.valueOf(reactStylesDiffMap.getInt(str3, 0)) : null);
        ...
        if (reactStylesDiffMap.hasKey(str4)) {
            readableMap = reactStylesDiffMap.getMap(str4);
        }
    ...
    public void setTextShadowOffset(ReadableMap readableMap) {
        ...
        if (readableMap != null) {
            ...
            if (readableMap.hasKey(str2) && !readableMap.isNull(str2)) {
                this.mTextShadowOffsetDy = PixelUtil.toPixelFromDIP(readableMap.getDouble(str2));
            }
        }
    }
