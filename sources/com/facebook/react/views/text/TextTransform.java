...
public enum TextTransform {
    ...
    static /* synthetic */ class C08761 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.text.TextTransform.C08761.<clinit>():void");
        }
    }
    ...
    public static String apply(String str, TextTransform textTransform) {
        ...
        int i = C08761.$SwitchMap$com$facebook$react$views$text$TextTransform[textTransform.ordinal()];
        if (i == 1) {
            str = str.toUpperCase();
        } else if (i == 2) {
            str = str.toLowerCase();
