    ...
    static /* synthetic */ class C08691 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.scroll.ScrollEventType.C08691.<clinit>():void");
        }
    }

    public static String getJSEventName(ScrollEventType scrollEventType) {
        int i = C08691.$SwitchMap$com$facebook$react$views$scroll$ScrollEventType[scrollEventType.ordinal()];
        if (i == 1) {
