...
public class ReactHorizontalScrollViewManager extends ViewGroupManager<ReactHorizontalScrollView> implements ScrollCommandHandler<ReactHorizontalScrollView> {
    ...
    public void receiveCommand(ReactHorizontalScrollView reactHorizontalScrollView, int i, @Nullable ReadableArray readableArray) {
        ReactScrollViewCommandHelper.receiveCommand((ScrollCommandHandler<T>) this, reactHorizontalScrollView, i, readableArray);
    }
    ...
    public void receiveCommand(ReactHorizontalScrollView reactHorizontalScrollView, String str, @Nullable ReadableArray readableArray) {
        ReactScrollViewCommandHelper.receiveCommand((ScrollCommandHandler<T>) this, reactHorizontalScrollView, str, readableArray);
    }
