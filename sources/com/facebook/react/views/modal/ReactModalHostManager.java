...
public class ReactModalHostManager extends ViewGroupManager<ReactModalHostView> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        return MapBuilder.builder().put(RequestCloseEvent.EVENT_NAME, MapBuilder.m125of(str, "onRequestClose")).put(ShowEvent.EVENT_NAME, MapBuilder.m125of(str, "onShow")).build();
    }
