...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        ...
        String str7 = "topBlur";
        return MapBuilder.builder().put(str4, MapBuilder.m125of(str3, MapBuilder.m126of(str2, "onSubmitEditing", str, "onSubmitEditingCapture"))).put(str5, MapBuilder.m125of(str3, MapBuilder.m126of(str2, "onEndEditing", str, "onEndEditingCapture"))).put(ReactTextInputEvent.EVENT_NAME, MapBuilder.m125of(str3, MapBuilder.m126of(str2, "onTextInput", str, "onTextInputCapture"))).put(str6, MapBuilder.m125of(str3, MapBuilder.m126of(str2, "onFocus", str, "onFocusCapture"))).put(str7, MapBuilder.m125of(str3, MapBuilder.m126of(str2, "onBlur", str, "onBlurCapture"))).put(ReactTextInputKeyPressEvent.EVENT_NAME, MapBuilder.m125of(str3, MapBuilder.m126of(str2, "onKeyPress", str, "onKeyPressCapture"))).build();
    }

    @Nullable
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(ScrollEventType.getJSEventName(ScrollEventType.SCROLL), MapBuilder.m125of("registrationName", "onScroll")).build();
    }

    @Nullable
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m126of("focusTextInput", Integer.valueOf(1), "blurTextInput", Integer.valueOf(2));
    }
    ...
    public void setUnderlineColor(ReactEditText reactEditText, @Nullable Integer num) {
        ...
        if (background.getConstantState() != null) {
            try {
                ...
                FLog.m51e(TAG, "NullPointerException when setting underlineColorAndroid for TextInput", (Throwable) e);
            }
        }
        if (num == null) {
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m125of("AutoCapitalizationType", MapBuilder.m128of(ViewProps.NONE, Integer.valueOf(0), "characters", Integer.valueOf(4096), "words", Integer.valueOf(8192), "sentences", Integer.valueOf(16384)));
    }
}
