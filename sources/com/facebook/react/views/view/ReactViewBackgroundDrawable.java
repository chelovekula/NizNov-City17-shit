...
public class ReactViewBackgroundDrawable extends Drawable {
    ...
    static /* synthetic */ class C08811 {
        ...
        static final /* synthetic */ int[] f56xe6ea8768 = new int[BorderStyle.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f56xe6ea8768 = r0
                int[] r0 = f56xe6ea8768     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f56xe6ea8768     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f56xe6ea8768     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.view.ReactViewBackgroundDrawable.C08811.<clinit>():void");
        }
    }
    ...
    private enum BorderStyle {
        ...
        public static PathEffect getPathEffect(BorderStyle borderStyle, float f) {
            int i = C08811.f56xe6ea8768[borderStyle.ordinal()];
            if (i == 1) {
                return null;
            }
            if (i == 2) {
