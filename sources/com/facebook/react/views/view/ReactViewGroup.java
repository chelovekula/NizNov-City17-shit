...
public class ReactViewGroup extends ViewGroup implements ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactHitSlopView, ReactZIndexedViewGroup {
    ...
    public void dispatchProvideStructure(ViewStructure viewStructure) {
        try {
            ...
            FLog.m51e(ReactConstants.TAG, "NullPointerException when executing dispatchProvideStructure", (Throwable) e);
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        try {
            ...
            FLog.m51e(ReactConstants.TAG, "NullPointerException when executing ViewGroup.dispatchDraw method", (Throwable) e);
    ...
    /* JADX INFO: used method not loaded: com.facebook.yoga.YogaConstants.isUndefined(float):null, types can be incorrect */
