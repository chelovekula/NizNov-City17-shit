    ...
    static /* synthetic */ class C08511 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.events.TouchEventType.C08511.<clinit>():void");
        }
    }

    public static String getJSEventName(TouchEventType touchEventType) {
        int i = C08511.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType[touchEventType.ordinal()];
        if (i == 1) {
