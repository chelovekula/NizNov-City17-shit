...
public class UIViewOperationQueue {
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long j) {
            if (UIViewOperationQueue.this.mIsInIllegalUIState) {
                FLog.m90w(ReactConstants.TAG, "Not flushing pending UI operations because of previously thrown Exception");
                return;
            }
    ...
    private final class UpdateLayoutOperation extends ViewOperation {
        ...
        /* renamed from: mX */
        private final int f51mX;

        /* renamed from: mY */
        private final int f52mY;
        ...
        public void execute() {
            ...
            UIViewOperationQueue.this.mNativeViewHierarchyManager.updateLayout(this.mParentTag, this.mTag, this.f51mX, this.f52mY, this.mWidth, this.mHeight);
        }
    }
    ...
    public void flushPendingBatches() {
        /*
            ...
            com.facebook.common.logging.FLog.m90w(r0, r1)
            return
        L_0x000c:
