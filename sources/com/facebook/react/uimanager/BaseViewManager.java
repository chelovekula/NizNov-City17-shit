...
public abstract class BaseViewManager<T extends View, C extends LayoutShadowNode> extends ViewManager<T, C> {
    ...
    static {
        sStateDescription.put(STATE_BUSY, Integer.valueOf(C0604R.string.state_busy_description));
        sStateDescription.put(STATE_EXPANDED, Integer.valueOf(C0604R.string.state_expanded_description));
        sStateDescription.put("collapsed", Integer.valueOf(C0604R.string.state_collapsed_description));
    }
    ...
    public void setAccessibilityRole(@NonNull T t, @Nullable String str) {
        if (str != null) {
            t.setTag(C0604R.C0606id.accessibility_role, AccessibilityRole.fromValue(str));
        }
    }

    @ReactProp(name = "accessibilityStates")
    public void setViewStates(@NonNull T t, @Nullable ReadableArray readableArray) {
        boolean z = t.getTag(C0604R.C0606id.accessibility_states) != null && readableArray == null;
        t.setTag(C0604R.C0606id.accessibility_states, readableArray);
        t.setSelected(false);
        t.setEnabled(true);
        if (readableArray != null) {
            boolean z2 = z;
    ...
    public void setViewState(@NonNull T t, @Nullable ReadableMap readableMap) {
        if (readableMap != null) {
            t.setTag(C0604R.C0606id.accessibility_state, readableMap);
            t.setSelected(false);
            t.setEnabled(true);
    ...
    private void updateViewContentDescription(@NonNull T t) {
        String str = (String) t.getTag(C0604R.C0606id.accessibility_label);
        ReadableArray readableArray = (ReadableArray) t.getTag(C0604R.C0606id.accessibility_states);
        ReadableMap readableMap = (ReadableMap) t.getTag(C0604R.C0606id.accessibility_state);
        String str2 = (String) t.getTag(C0604R.C0606id.accessibility_hint);
        ...
        if (readableMap != null) {
            ...
            while (keySetIterator.hasNextKey()) {
                ...
                if (nextKey.equals(STATE_CHECKED) && dynamic.getType() == ReadableType.String && dynamic.asString().equals(STATE_MIXED)) {
                    arrayList.add(t.getContext().getString(C0604R.string.state_mixed_description));
                } else if (nextKey.equals(STATE_BUSY) && dynamic.getType() == ReadableType.Boolean && dynamic.asBoolean()) {
                    arrayList.add(t.getContext().getString(C0604R.string.state_busy_description));
                } else if (nextKey.equals(STATE_EXPANDED) && dynamic.getType() == ReadableType.Boolean) {
                    arrayList.add(t.getContext().getString(dynamic.asBoolean() ? C0604R.string.state_expanded_description : C0604R.string.state_collapsed_description));
                }
            }
        }
        if (str2 != null) {
    ...
    public void setAccessibilityActions(T t, ReadableArray readableArray) {
        if (readableArray != null) {
            t.setTag(C0604R.C0606id.accessibility_actions, readableArray);
        }
    }
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put("topAccessibilityAction", MapBuilder.m125of("registrationName", "onAccessibilityAction")).build();
    }
    ...
    private void logUnsupportedPropertyWarning(String str) {
        FLog.m92w(ReactConstants.TAG, "%s doesn't support property '%s'", getName(), str);
    }
}
