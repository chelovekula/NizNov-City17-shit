...
public class ReactContext extends ContextWrapper {
    ...
    static /* synthetic */ class C06802 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.ReactContext.C06802.<clinit>():void");
        }
    }
    ...
    public void addLifecycleEventListener(final LifecycleEventListener lifecycleEventListener) {
        ...
        if (hasActiveCatalystInstance()) {
            int i = C06802.$SwitchMap$com$facebook$react$common$LifecycleState[this.mLifecycleState.ordinal()];
            if (i != 1 && i != 2) {
                if (i == 3) {
