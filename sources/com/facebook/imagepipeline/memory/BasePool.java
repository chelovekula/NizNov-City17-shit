...
public abstract class BasePool<V> implements Pool<V> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x009d, code lost:
        com.facebook.common.logging.FLog.m72v(r5.TAG, "get (alloc) (object, size) = (%x, %s)", (java.lang.Object) java.lang.Integer.valueOf(java.lang.System.identityHashCode(r0)), (java.lang.Object) java.lang.Integer.valueOf(r6));
     */
    ...
    public V get(int r6) {
        /*
            ...
            com.facebook.common.logging.FLog.m72v(r0, r1, r3, r6)     // Catch:{ all -> 0x00ca }
        L_0x0051:
        ...
        L_0x0082:
            ...
            com.facebook.common.logging.FLog.m72v(r1, r2, r3, r6)     // Catch:{ all -> 0x00b2 }
        L_0x00b0:
    ...
    public void release(V v) {
        ...
        synchronized (this) {
            ...
            if (!this.mInUseValues.remove(v)) {
                FLog.m48e(this.TAG, "release (free, value unrecognized) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(v)), Integer.valueOf(bucketedSizeForValue));
                free(v);
                ...
                if (bucketIfPresent != null && !bucketIfPresent.isMaxLengthExceeded() && !isMaxSizeSoftCapExceeded()) {
                    if (isReusable(v)) {
                        ...
                        if (FLog.isLoggable(2)) {
                            FLog.m72v(this.TAG, "release (reuse) (object, size) = (%x, %s)", (Object) Integer.valueOf(System.identityHashCode(v)), (Object) Integer.valueOf(bucketedSizeForValue));
                        }
                    }
                }
                ...
                if (FLog.isLoggable(2)) {
                    FLog.m72v(this.TAG, "release (free) (object, size) = (%x, %s)", (Object) Integer.valueOf(System.identityHashCode(v)), (Object) Integer.valueOf(bucketedSizeForValue));
                }
                free(v);
                this.mUsed.decrement(sizeInBytes);
                this.mPoolStatsTracker.onFree(sizeInBytes);
    ...
    public synchronized void trimToSize(int r8) {
        ...
        L_0x0017:
            ...
            com.facebook.common.logging.FLog.m73v(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x008e }
        L_0x003a:
        ...
        L_0x006b:
            ...
            com.facebook.common.logging.FLog.m72v(r0, r1, r8, r2)     // Catch:{ all -> 0x008e }
        L_0x008c:
            monitor-exit(r7)
            return
        L_0x008e:
    ...
    public synchronized com.facebook.imagepipeline.memory.Bucket<V> getBucket(int r4) {
        ...
        L_0x0010:
            ...
            com.facebook.common.logging.FLog.m71v(r0, r1, r2)     // Catch:{ all -> 0x002f }
        L_0x0022:
    ...
    private void logStats() {
        if (FLog.isLoggable(2)) {
            FLog.m74v(this.TAG, "Used = (%d, %d); Free = (%d, %d)", (Object) Integer.valueOf(this.mUsed.mCount), (Object) Integer.valueOf(this.mUsed.mNumBytes), (Object) Integer.valueOf(this.mFree.mCount), (Object) Integer.valueOf(this.mFree.mNumBytes));
        }
    }
