...
public class ImagePipeline {
    ...
    static /* synthetic */ class C05378 {

        /* renamed from: $SwitchMap$com$facebook$imagepipeline$request$ImageRequest$CacheChoice */
        static final /* synthetic */ int[] f34x9ce557aa = new int[CacheChoice.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f34x9ce557aa = r0
                int[] r0 = f34x9ce557aa     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f34x9ce557aa     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.core.ImagePipeline.C05378.<clinit>():void");
        }
    }
    ...
    public Supplier<DataSource<CloseableReference<CloseableImage>>> getDataSourceSupplier(ImageRequest imageRequest, Object obj, RequestLevel requestLevel, @Nullable RequestListener requestListener) {
        ...
        C05312 r0 = new Supplier<DataSource<CloseableReference<CloseableImage>>>() {
            public DataSource<CloseableReference<CloseableImage>> get() {
    ...
    public void clearMemoryCaches() {
        C05334 r0 = new Predicate<CacheKey>() {
    ...
    public boolean isInDiskCacheSync(ImageRequest imageRequest) {
        CacheKey encodedCacheKey = this.mCacheKeyFactory.getEncodedCacheKey(imageRequest, null);
        int i = C05378.f34x9ce557aa[imageRequest.getCacheChoice().ordinal()];
        if (i == 1) {
