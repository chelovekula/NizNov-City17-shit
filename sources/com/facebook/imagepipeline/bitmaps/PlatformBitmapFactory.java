...
public abstract class PlatformBitmapFactory {
    ...
    static /* synthetic */ class C05141 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory.C05141.<clinit>():void");
        }
    }
    ...
    private static Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        int i = C05141.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
        if (i == 1) {
