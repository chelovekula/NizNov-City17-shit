...
public class LocalExifThumbnailProducer implements ThumbnailProducer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final C05651 r0 = new StatefulProducerRunnable<EncodedImage>(consumer, listener, PRODUCER_NAME, id) {
            ...
            public Map<String, String> getExtraMapOnSuccess(EncodedImage encodedImage) {
                return ImmutableMap.m22of(LocalExifThumbnailProducer.CREATED_THUMBNAIL, Boolean.toString(encodedImage != null));
            }
        };
    ...
    public ExifInterface getExifInterface(Uri uri) {
        ...
        try {
            ...
            FLog.m46e(LocalExifThumbnailProducer.class, "StackOverflowError in ExifInterface constructor");
        }
        return null;
    }
    ...
    public EncodedImage buildEncodedImage(PooledByteBuffer pooledByteBuffer, ExifInterface exifInterface) {
        ...
        CloseableReference of = CloseableReference.m114of(pooledByteBuffer);
        try {
