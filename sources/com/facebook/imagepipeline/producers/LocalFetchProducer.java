...
public abstract class LocalFetchProducer implements Producer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final C05671 r0 = new StatefulProducerRunnable<EncodedImage>(consumer, listener, getProducerName(), id) {
            /* access modifiers changed from: protected */
            @Nullable
    ...
    public EncodedImage getByteBufferBackedEncodedImage(InputStream inputStream, int i) throws IOException {
        ...
        if (i <= 0) {
            try {
                closeableReference = CloseableReference.m114of(this.mPooledByteBufferFactory.newByteBuffer(inputStream));
            } catch (Throwable th) {
            ...
            closeableReference = CloseableReference.m114of(this.mPooledByteBufferFactory.newByteBuffer(inputStream, i));
        }
