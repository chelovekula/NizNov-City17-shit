...
public class StagingArea {
    ...
    public synchronized com.facebook.imagepipeline.image.EncodedImage get(com.facebook.cache.common.CacheKey r7) {
        /*
            ...
            com.facebook.common.logging.FLog.m88w(r1, r2, r3)     // Catch:{ all -> 0x004b }
            r7 = 0
    ...
    public synchronized boolean containsKey(CacheKey cacheKey) {
        ...
        synchronized (encodedImage) {
            ...
            this.mMap.remove(cacheKey);
            FLog.m88w(TAG, "Found closed reference %d for key %s (%d)", Integer.valueOf(System.identityHashCode(encodedImage)), cacheKey.getUriString(), Integer.valueOf(System.identityHashCode(cacheKey)));
            return false;
        }
    }

    private synchronized void logStats() {
        FLog.m71v(TAG, "Count = %d", (Object) Integer.valueOf(this.mMap.size()));
    }
}
