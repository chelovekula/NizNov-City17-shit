...
public enum TriState {
    ...
    static /* synthetic */ class C04861 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.common.util.TriState.C04861.<clinit>():void");
        }
    }
    ...
    public boolean asBoolean() {
        int i = C04861.$SwitchMap$com$facebook$common$util$TriState[ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
