        ...
        public void run() {
            ...
            try {
                ...
                if (runnable != null) {
                    ...
                    FLog.m71v(ConstrainedExecutorService.TAG, "%s: Worker has nothing to run", (Object) ConstrainedExecutorService.this.mName);
                }
            } finally {
                ...
                if (!ConstrainedExecutorService.this.mWorkQueue.isEmpty()) {
                    ...
                    FLog.m72v(ConstrainedExecutorService.TAG, str, (Object) ConstrainedExecutorService.this.mName, (Object) Integer.valueOf(decrementAndGet));
                }
            }
        }
    }
    ...
    public void execute(Runnable runnable) {
        if (runnable == null) {
            ...
            if (size > i && this.mMaxQueueSize.compareAndSet(i, size)) {
                FLog.m72v(TAG, "%s: max pending work in queue = %d", (Object) this.mName, (Object) Integer.valueOf(size));
            }
            startWorkerIfNeeded();
        } else {
    ...
    public void startWorkerIfNeeded() {
        ...
        while (i < this.mMaxConcurrency) {
            ...
            if (this.mPendingWorkers.compareAndSet(i, i2)) {
                FLog.m73v(TAG, "%s: starting worker %d of %d", (Object) this.mName, (Object) Integer.valueOf(i2), (Object) Integer.valueOf(this.mMaxConcurrency));
                this.mExecutor.execute(this.mTaskRunner);
                return;
            }
            FLog.m71v(TAG, "%s: race in startWorkerIfNeeded; retrying", (Object) this.mName);
