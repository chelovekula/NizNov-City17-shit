...
public final class CloseableReference<T> implements Cloneable, Closeable {
    ...
    private static final LeakHandler DEFAULT_LEAK_HANDLER = new LeakHandler() {
        ...
        public void reportLeak(SharedReference<Object> sharedReference, @Nullable Throwable th) {
            FLog.m88w(CloseableReference.TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(sharedReference)), sharedReference.get().getClass().getName());
        }
    };
    ...
    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m114of(@PropagatesNullable T t) {
        return m116of(t, DEFAULT_CLOSEABLE_RELEASER);
    }

    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m115of(@PropagatesNullable T t, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: of */
    public static <T> CloseableReference<T> m116of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser) {
        return m117of(t, resourceReleaser, DEFAULT_LEAK_HANDLER);
    }

    /* renamed from: of */
    public static <T> CloseableReference<T> m117of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler) {
        Throwable th = null;
        if (t == null) {
            return null;
        }
