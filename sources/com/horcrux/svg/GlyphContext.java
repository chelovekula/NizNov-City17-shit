...
class GlyphContext {
    ...
    public double nextX(double d) {
        ...
        if (i < sVGLengthArr.length) {
            this.mDX = 0.0d;
            this.mXIndex = i;
            this.f61mX = PropHelper.fromRelative(sVGLengthArr[i], (double) this.mWidth, 0.0d, (double) this.mScale, this.mFontSize);
        }
        this.f61mX += d;
        return this.f61mX;
    }
    ...
    public double nextY() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDY = 0.0d;
            this.mYIndex = i;
            this.f62mY = PropHelper.fromRelative(sVGLengthArr[i], (double) this.mHeight, 0.0d, (double) this.mScale, this.mFontSize);
        }
        return this.f62mY;
    }
