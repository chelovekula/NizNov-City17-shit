...
class SVGLength {
    ...
    static /* synthetic */ class C09251 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.horcrux.svg.SVGLength.C09251.<clinit>():void");
        }
    }
    ...
    static SVGLength from(Dynamic dynamic) {
        int i = C09251.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()];
        if (i == 1) {
